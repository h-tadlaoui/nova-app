"""
Django settings for nova_project.
"""
import os
...
# To use PostgreSQL, uncomment the PostgreSQL config and comment out SQLite
DATABASES = {
    'default': {
...
#         'NAME': os.getenv('DATABASE_NAME', 'nova_db'),
...
# AI Service URL
AI_SERVICE_URL = os.getenv('AI_SERVICE_URL', 'http://localhost:3300')
