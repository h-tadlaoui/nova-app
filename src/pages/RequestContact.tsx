...
const RequestContact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success("Contact request sent!", {
      description: "The finder will review your request and share their contact if approved"
    });
    ...
    <div className="min-h-screen bg-background pb-20">
      <header className="sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b">
        <div className="flex items-center gap-3 p-4">
          ...
          <div>
            <h1 className="text-lg font-semibold">Request Contact</h1>
      ...
      <main className="p-4 space-y-6">
        <Card className="p-4 bg-primary/5 border-primary/20">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-medium text-sm">Request Finder's Contact</h3>
              <p className="text-xs text-muted-foreground mt-1">
                Provide details that prove this item belongs to you. The finder will review your request and share their contact info if approved.
              </p>
            </div>
          </div>
        </Card>
